...
public class SetupGameLayerFlat extends AbstractGameLayerFlat implements UnitTouchListener, BackListener {
	...
	public SetupGameLayerFlat(Context context, SceneManager sceneManager, Game game) {
