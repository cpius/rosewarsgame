...
public class BoardframeFlat implements Boardframe {
	...
	public BoardframeFlat(int xCount, int yCount, float frameWidth, float frameHeight, float margen, float scale, float perimeterScale) {
		this.xCount = xCount;
		this.yCount = yCount;		
