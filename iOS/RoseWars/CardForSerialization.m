...
- (id)initWithCard:(Card*)card {
    ...
    if (self) {
        ...
        for (TimedAbility *ability in card.currentlyAffectedByAbilities) {
            [_affectedByAbilities addObject:[[[TimedAbilityForSerialization alloc] initWithTimedAbility:ability currentTurn:card.gamemanager.currentGame.turnCounter] asDictionary]];
        }
